...
class SampleView : BaseView {
    ...
    override func setup() {
        points.insert(Point(x: -500, y: -500, z: 500), at: 0)
        points.insert(Point(x:  500, y: -500, z: 500), at: 1)
        points.insert(Point(x:  500, y: -500, z:  -500), at: 2)
        points.insert(Point(x: -500, y: -500, z:  -500), at: 3)
        
        points.insert(Point(x: -500, y: 500, z: 500), at: 4)
        points.insert(Point(x:  500, y: 500, z: 500), at: 5)
