...
public struct Vector {
    ...
    public mutating func setX(_ value:Float) {
        return _x = value
    }
    ...
    public mutating func setY(_ value:Float) {
        _y = value
    }
    ...
    public mutating func setAngle(_ angle:Float) {
    ...
    public mutating func addTo(_ v2:Vector) {
        _x += v2.getX()
        _y += v2.getY()
    }
    
    public mutating func subtractFrom(_ v2:Vector) {
        _x -= v2.getX()
        _y -= v2.getY()
    }
    
    public mutating func multiplyBy(_ val:Float) {
        _x *= val
        _y *= val
    }
    
    public mutating func divideBy(_ val:Float) {
        _x /= val
        _y /= val
    }
}
